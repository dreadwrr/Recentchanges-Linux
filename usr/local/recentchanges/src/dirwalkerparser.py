...
def build_dwalk_parser():
    ...
    scan_p.add_argument("xdg_settings", nargs="?", type=str, default="", help="to pass XDG environment variables (default: \"\")")
    ...
    build_p.add_argument("xdg_settings", nargs="?", type=str, default="", help="to pass XDG environment variables (default: \"\")")
    ...
    downloads_p.add_argument("xdg_settings", nargs="?", type=str, default="", help="to pass XDG environment variables (default: \"\")")
