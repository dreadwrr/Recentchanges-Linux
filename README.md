...
sqlcipher would need to be made as it is probably not in the package manager. see porteus install instructions to make a .xzm of packages you cant find on there. <br>
